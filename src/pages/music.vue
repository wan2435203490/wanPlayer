<template>
  <div class="music flex-col">
    ...
    <div class="music-bar" :class="{ disable: !musicReady || !currentMusic.id }">
      ...
      <div class="music-music">
        <div class="music-bar-info">
          ...
          <template v-else>欢迎使用wanPlayer在线音乐播放器</template>
        </div>
    ...
    <!--遮罩-->
    <div class="wanPlayer-bg" :style="{ backgroundImage: picUrl }"></div>
    <div class="wanPlayer-mask"></div>
  </div>
</template>

<script>
import { getLyric } from 'api'
import wanPlayerMusic from './wanPlayer'
